...
import (
	...
	operatorv1alpha1 "github.com/rajnco/nginx-operator/api/v1alpha1"
	"github.com/rajnco/nginx-operator/assets"
)
...
// +kubebuilder:rbac:groups=operator.rajnco.com,resources=nginxoperators,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=operator.rajnco.com,resources=nginxoperators/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=operator.rajnco.com,resources=nginxoperators/finalizers,verbs=update
